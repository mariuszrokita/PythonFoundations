...
def play_word_game():
    ...
    blanked_word = list("_" * len(word))                # nice way of building string consisting of only one letter
                                                        # additionally the string is created as a list of letters
